...
export default function AmbientBackground() {
  ...
  useEffect(() => {
    ...
    // Pre-calculate constants to avoid recomputation and garbage collection in the render loop
    const PI2 = Math.PI * 2;
    ...
    const build = () => {
      ...
      particles = Array.from({ length: count }, () => {
        ...
        // Precalculate values that don't change per frame to save CPU
        return {
          x: Math.random() * w,
          y: Math.random() * h,
          ...
          color: `rgba(163, 118, 60, ${a * (0.6 + z * 0.5)})`, // Pre-allocate string to prevent GC pauses
        };
      });
    };
