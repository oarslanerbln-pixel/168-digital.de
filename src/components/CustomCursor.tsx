...
export default function CustomCursor() {
  // Use Framer Motion values to avoid triggering React re-renders on mousemove
  ...
  useEffect(() => {
    ...
    const updateMousePosition = (e: MouseEvent) => {
      // Offset by 16px to center the 32x32px cursor exactly on the pointer
  ...
  return (
    <>
      <motion.div
        ...
        animate={{
          // Use scale instead of width/height to avoid layout thrashing
          scale: isHovered ? 1 : 0.1875, // 0.1875 * 32 = 6px
