...
const resources = {
  en: {
    translation: {
      "meta_title": "1618 Digital | Web, AI & Cinematic Production Studio · Berlin",
      "meta_description": "1618 Digital builds websites & 3D SaaS platforms, 24/7 AI voice agents, and cinematic video, drone & wedding productions in Berlin. End-to-end digital solutions that grow your brand.",
      ...
      "contact_page_meta_description": "Get in touch with 1618 Digital in Berlin — web & SaaS development, AI voice agents, and cinematic production. Reach us by form, email or WhatsApp.",
  ...
  de: {
    translation: {
      "meta_title": "1618 Digital | Web-, KI- & Kino-Produktionsstudio · Berlin",
      "meta_description": "1618 Digital entwickelt Websites & 3D-SaaS-Plattformen, KI-Sprachagenten rund um die Uhr sowie kinoreife Video-, Drohnen- und Hochzeitsproduktionen in Berlin. Digitale Komplettlösungen für Ihr Wachstum.",
      ...
      "contact_page_meta_description": "Kontaktieren Sie 1618 Digital in Berlin — Web- & SaaS-Entwicklung, KI-Sprachagenten und Kino-Produktion. Erreichbar per Formular, E-Mail oder WhatsApp.",
  ...
  tr: {
    translation: {
      "meta_title": "1618 Digital | Web, Yapay Zeka & Sinematik Prodüksiyon Stüdyosu · Berlin",
      "meta_description": "1618 Digital, Berlin'de web siteleri & 3D SaaS platformları, 7/24 yapay zeka sesli asistanlar ve sinematik video, drone & düğün prodüksiyonları geliştirir. Markanızı büyüten uçtan uca dijital çözümler.",
      ...
      "contact_page_meta_description": "1618 Digital Berlin ile iletişime geçin — web & SaaS geliştirme, yapay zeka sesli asistan ve sinematik prodüksiyon. Form, e-posta veya WhatsApp ile ulaşın.",
