...
const resources = {
  en: {
    translation: {
      ...
      "hero_subtitle": "Cinematic video, drone & wedding productions, and custom websites — end-to-end digital solutions that grow your brand.",
  ...
  de: {
    translation: {
      ...
      "hero_subtitle": "Kinoreife Video-, Drohnen- und Hochzeitsproduktionen sowie individuelle Websites — digitale Komplettlösungen, die Ihre Marke wachsen lassen.",
  ...
  tr: {
    translation: {
      ...
      "hero_subtitle": "Sinematik video, drone ve düğün çekimleri, ve özel web siteleri — markanızı büyüten uçtan uca dijital çözümler.",
