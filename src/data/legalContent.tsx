...
/**
 * Shared Impressum / Datenschutz content, used both by the quick-view
 * modal (LegalModal) and by the standalone, crawlable /impressum and
 * /datenschutz routes (LegalPage) — kept in one place so the two never
 * drift apart.
 */
export const legalContent: Record<'impressum' | 'datenschutz', LegalSection> = {
  impressum: {
    title: 'Impressum',
    text: (
      <>
