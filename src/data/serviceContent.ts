...
export const serviceContent: Record<string, Record<Lang, ServicePageContent>> = {
  ...
  'ai-voice-agents': {
    en: {
      ...
      h1: 'AI Voice Agents & Chatbots for 24/7 Lead Capture',
      intro: [
        'Every missed call is a missed customer. We build AI voice agents that answer your phone around the clock, sound natural in conversation, and handle bookings, FAQs and lead qualification — so no inquiry ever goes unanswered again.',
        'Beyond the phone, we integrate website chatbots and automation workflows that connect directly to your calendar, CRM or booking system, giving you a consistent, always-on front line for your business.',
      ],
      features: [
        { title: '24/7 AI Voice Receptionist', desc: 'Human-like voice agents that answer calls, qualify leads and log every conversation.' },
        { title: 'Website Chat Assistant', desc: 'A branded chat widget that answers visitor questions instantly and captures contact details.' },
        { title: 'Appointment Booking', desc: 'Direct integration with your calendar so callers can book a slot without human intervention.' },
        { title: 'Multilingual Conversations', desc: 'Agents fluent in German, English and Turkish to match your customer base.' },
        { title: 'CRM & Workflow Integration', desc: 'Leads flow straight into your existing tools — no manual data entry.' },
        { title: 'Full Conversation Analytics', desc: 'Transparent logs and reporting so you always know what was said and by whom.' },
      ],
      process: [
        { title: 'Define the Script', desc: 'We map your most common calls and inquiries into a natural, on-brand conversation flow.' },
        { title: 'Build & Train', desc: 'The agent is configured, tested against real scenarios, and tuned to your voice and tone.' },
        { title: 'Go Live & Refine', desc: 'We connect it to your phone line or site, then review real conversations to keep improving it.' },
      ],
      faq: [
        { q: 'Will callers know they\'re speaking to an AI?', a: 'We design agents to be transparent when asked, while still sounding natural and helpful throughout the call.' },
        { q: 'Can the AI agent book appointments directly?', a: 'Yes — it connects to your calendar or booking system and can schedule, reschedule or cancel appointments in real time.' },
        { q: 'How long does setup take?', a: 'A standard voice agent is live within 1–2 weeks, including scripting, testing and integration with your existing systems.' },
      ],
      ctaTitle: 'Stop missing calls and leads.',
      ctaText: 'Tell us how your customers reach you today, and we\'ll design an AI agent that fits your business.',
      relatedWorkIds: [],
    },
    de: {
      ...
      h1: 'KI-Sprachassistenten & Chatbots für Leads rund um die Uhr',
      intro: [
        'Jeder verpasste Anruf ist ein verpasster Kunde. Wir entwickeln KI-Sprachassistenten, die Ihr Telefon rund um die Uhr beantworten, natürlich klingen und Buchungen, FAQs und Lead-Qualifizierung übernehmen — damit keine Anfrage mehr unbeantwortet bleibt.',
        'Über das Telefon hinaus integrieren wir Website-Chatbots und Automatisierungs-Workflows, die direkt mit Ihrem Kalender, CRM oder Buchungssystem verbunden sind — für eine durchgängige, immer erreichbare erste Anlaufstelle für Ihr Unternehmen.',
      ],
      features: [
        { title: 'KI-Telefonassistent rund um die Uhr', desc: 'Menschlich klingende Sprachassistenten, die Anrufe entgegennehmen, Leads qualifizieren und jedes Gespräch protokollieren.' },
        { title: 'Website-Chat-Assistent', desc: 'Ein gebrandetes Chat-Widget, das Besucherfragen sofort beantwortet und Kontaktdaten erfasst.' },
        { title: 'Terminbuchung', desc: 'Direkte Anbindung an Ihren Kalender, sodass Anrufer ohne menschliches Zutun einen Termin buchen können.' },
        { title: 'Mehrsprachige Gespräche', desc: 'Assistenten, die fließend Deutsch, Englisch und Türkisch sprechen — passend zu Ihrer Kundschaft.' },
        { title: 'CRM- & Workflow-Integration', desc: 'Leads fließen direkt in Ihre bestehenden Tools — keine manuelle Dateneingabe.' },
        { title: 'Vollständige Gesprächsanalyse', desc: 'Transparente Protokolle und Reportings, damit Sie immer wissen, was gesagt wurde und von wem.' },
      ],
      process: [
        { title: 'Skript definieren', desc: 'Wir übersetzen Ihre häufigsten Anrufe und Anfragen in einen natürlichen, markenkonformen Gesprächsablauf.' },
        { title: 'Aufbau & Training', desc: 'Der Assistent wird konfiguriert, an realen Szenarien getestet und auf Ihre Stimme und Ihren Ton abgestimmt.' },
        { title: 'Live-Gang & Optimierung', desc: 'Wir verbinden ihn mit Ihrer Telefonleitung oder Website und verbessern ihn anhand echter Gespräche kontinuierlich.' },
      ],
      faq: [
        { q: 'Merken Anrufer, dass sie mit einer KI sprechen?', a: 'Unsere Assistenten sind transparent, wenn danach gefragt wird, klingen dabei aber während des gesamten Gesprächs natürlich und hilfsbereit.' },
        { q: 'Kann der KI-Assistent direkt Termine buchen?', a: 'Ja — er ist mit Ihrem Kalender oder Buchungssystem verbunden und kann Termine in Echtzeit vereinbaren, verschieben oder stornieren.' },
        { q: 'Wie lange dauert die Einrichtung?', a: 'Ein Standard-Sprachassistent ist inklusive Skripterstellung, Tests und Integration innerhalb von 1–2 Wochen einsatzbereit.' },
      ],
      ctaTitle: 'Verpassen Sie keine Anrufe und Leads mehr.',
      ctaText: 'Erzählen Sie uns, wie Ihre Kunden Sie heute erreichen — wir entwerfen einen KI-Assistenten, der zu Ihrem Unternehmen passt.',
      relatedWorkIds: [],
    },
    tr: {
      ...
      h1: '7/24 Lead Yakalayan Yapay Zeka Sesli Asistan & Chatbotlar',
      intro: [
        'Kaçırılan her arama, kaçırılan bir müşteridir. Telefonunuzu 7/24 yanıtlayan, doğal konuşan ve rezervasyon, sık sorulan sorular ile lead ön değerlendirmesini üstlenen yapay zeka sesli asistanlar geliştiriyoruz — böylece hiçbir talep cevapsız kalmıyor.',
        'Telefonun ötesinde, takviminize, CRM\'inize veya rezervasyon sisteminize doğrudan bağlanan web sitesi chatbot\'ları ve otomasyon iş akışları da entegre ediyoruz; işletmeniz için tutarlı, her zaman açık bir ön hat oluşturuyoruz.',
      ],
      features: [
        { title: '7/24 Yapay Zeka Sesli Resepsiyonist', desc: 'Aramaları yanıtlayan, lead\'leri niteleyen ve her konuşmayı kaydeden insan sesi doğallığında asistanlar.' },
        { title: 'Web Sitesi Sohbet Asistanı', desc: 'Ziyaretçi sorularını anında yanıtlayan ve iletişim bilgilerini toplayan markalı bir sohbet widget\'ı.' },
        { title: 'Randevu Rezervasyonu', desc: 'Takviminizle doğrudan entegrasyon sayesinde arayanlar insan müdahalesi olmadan randevu alabilir.' },
        { title: 'Çok Dilli Görüşmeler', desc: 'Müşteri kitlenize uygun şekilde Almanca, İngilizce ve Türkçe akıcı konuşan asistanlar.' },
        { title: 'CRM & İş Akışı Entegrasyonu', desc: 'Lead\'ler doğrudan mevcut araçlarınıza akar — manuel veri girişi yok.' },
        { title: 'Tam Görüşme Analitiği', desc: 'Neyin, kim tarafından söylendiğini her zaman bilmeniz için şeffaf kayıtlar ve raporlama.' },
      ],
      process: [
        { title: 'Senaryoyu Tanımlama', desc: 'En sık aldığınız aramaları ve talepleri, markanıza uygun doğal bir konuşma akışına dönüştürüyoruz.' },
        { title: 'Kurulum & Eğitim', desc: 'Asistan yapılandırılır, gerçek senaryolara karşı test edilir ve sesinize/tonunuza göre ayarlanır.' },
        { title: 'Yayına Alma & İyileştirme', desc: 'Telefon hattınıza veya sitenize bağlarız, ardından gerçek görüşmeleri inceleyerek sürekli geliştiririz.' },
      ],
      faq: [
        { q: 'Arayanlar yapay zeka ile konuştuklarını anlar mı?', a: 'Sorulduğunda şeffaf olacak şekilde tasarlıyoruz, ancak görüşme boyunca doğal ve yardımsever bir ton koruyor.' },
        { q: 'Yapay zeka asistanı doğrudan randevu ayarlayabilir mi?', a: 'Evet — takviminize veya rezervasyon sisteminize bağlanır ve gerçek zamanlı olarak randevu oluşturabilir, erteleyebilir veya iptal edebilir.' },
        { q: 'Kurulum ne kadar sürer?', a: 'Standart bir sesli asistan; senaryo yazımı, test ve mevcut sistemlerinizle entegrasyon dahil 1-2 hafta içinde yayında olur.' },
      ],
      ctaTitle: 'Artık arama ve lead kaçırmayın.',
      ctaText: 'Müşterilerinizin size bugün nasıl ulaştığını anlatın, işletmenize uygun bir yapay zeka asistanı tasarlayalım.',
      relatedWorkIds: [],
    },
  },
