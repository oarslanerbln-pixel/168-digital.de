...
## 2023-10-27 - [Reverse Tabnabbing in window.open]
**Vulnerability:** Programmatic `window.open` calls lacked `noopener,noreferrer` arguments, exposing the app to reverse tabnabbing.
